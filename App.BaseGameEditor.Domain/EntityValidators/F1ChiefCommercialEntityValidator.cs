...
{
    public class F1ChiefCommercialEntityValidator : IEntityValidator<F1ChiefCommercialEntity>
    {
        public IEnumerable<string> Validate(F1ChiefCommercialEntity entity)
        {
