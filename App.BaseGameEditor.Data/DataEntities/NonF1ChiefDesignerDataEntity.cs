...
{
    public class NonF1ChiefDesignerDataEntity : IntegerIdentityBase, IEntity
    {
        public NonF1ChiefDesignerDataEntity(LanguageCatalogueValue languageCatalogueValue)
        {
