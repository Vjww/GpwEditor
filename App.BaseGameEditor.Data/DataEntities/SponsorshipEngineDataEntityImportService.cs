...
{
    public class SponsorshipEngineDataEntityImportService : IDataEntityImportService<SponsorshipEngineDataEntity>
    {
        private readonly DataEndpoint _dataEndpoint;
        private readonly IIntegerIdentityFactory<SponsorshipEngineDataEntity> _dataEntityFactory;
        ...
        public SponsorshipEngineDataEntityImportService(
            DataEndpoint dataEndpoint,
            IIntegerIdentityFactory<SponsorshipEngineDataEntity> dataEntityFactory,
        ...
        public SponsorshipEngineDataEntity Import(int id)
        {
            ...
            result.SponsorId = id + 1 + 10;
            result.SponsorType = _identityCalculator.GetSponsorTypeId(id + 10);
