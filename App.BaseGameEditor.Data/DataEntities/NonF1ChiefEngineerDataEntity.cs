...
{
    public class NonF1ChiefEngineerDataEntity : IntegerIdentityBase, IEntity
    {
        public NonF1ChiefEngineerDataEntity(LanguageCatalogueValue languageCatalogueValue)
        {
