...
{
    public class NonF1ChiefEngineerDataLocator : IntegerIdentityBase, IDataLocator
    {
        ...
        public NonF1ChiefEngineerDataLocator(IdentityCalculator calculator)
        {
        ...
        {
            Name = NameOffset + _calculator.GetNonF1ChiefEngineerNameId(Id);
