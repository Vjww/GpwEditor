...
{
    public class F1ChiefDesignerDataLocator : IntegerIdentityBase, IDataLocator
    {
        ...
        public F1ChiefDesignerDataLocator(IdentityCalculator calculator)
        {
        ...
        {
            Name = NameOffset + _calculator.GetF1ChiefDesignerNameId(Id);
