...
namespace Data.ValueMapping.Executable.Environment.TestingMiles
{
    public class TestingMiles : ITenValueMapping
    {
        private const int NameIndex = 2681;

        private const int BaseOffset = 2693272;
