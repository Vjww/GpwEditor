namespace Data.Patchers.Enhancements.Units
{
    ...
    /// per position.
    /// 
    /// This update is for the points system that ran in F1 from 2010-onwards.
    ///  1st = 25
    ///  2nd = 18
    ///  3rd = 15
    ///  4th = 12
        ...
        public PointsSystemF1201020xxUpdate(string executableFilePath) : base(executableFilePath)
        {
            ...
            ModifiedInstructions.Add(new DataPatcherUnitTask
            {
                ...
                Instructions = new byte[]
                {
                    ...
                    0xC7, 0x45, 0x9C, 0x19, 0x00, 0x00, 0x00,                           // .text:005B8C6D                 mov     [ebp+var_64], 19h
                    0xC7, 0x45, 0xA0, 0x12, 0x00, 0x00, 0x00,                           // .text:005B8C74                 mov     [ebp+var_60], 12h
                    0xC7, 0x45, 0xA4, 0x0F, 0x00, 0x00, 0x00,                           // .text:005B8C7B                 mov     [ebp+var_5C], 0Fh
                    0xC7, 0x45, 0xA8, 0x0C, 0x00, 0x00, 0x00,                           // .text:005B8C82                 mov     [ebp+var_58], 0Ch
                    0xC7, 0x45, 0xAC, 0x0A, 0x00, 0x00, 0x00,                           // .text:005B8C89                 mov     [ebp+var_54], 0Ah
                    0xC7, 0x45, 0xB0, 0x08, 0x00, 0x00, 0x00,                           // .text:005B8C90                 mov     [ebp+var_50], 8
                    0xC7, 0x45, 0xB4, 0x06, 0x00, 0x00, 0x00,                           // .text:005B8C97                 mov     [ebp+var_4C], 6
                    0xC7, 0x45, 0xB8, 0x04, 0x00, 0x00, 0x00,                           // .text:005B8C9E                 mov     [ebp+var_48], 4
                    0xC7, 0x45, 0xBC, 0x02, 0x00, 0x00, 0x00,                           // .text:005B8CA5                 mov     [ebp+var_44], 2
                    0xC7, 0x45, 0xC0, 0x01, 0x00, 0x00, 0x00,                           // .text:005B8CAC                 mov     [ebp+var_40], 1
                    ...
                    0x83, 0x7D, 0xFC, 0x0A,                                             // .text:005B8D13                 cmp     [ebp+var_4], 10 ; points positions
