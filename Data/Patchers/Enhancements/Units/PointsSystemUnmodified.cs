        ...
        public PointsSystemUnmodified()
        {
            UnmodifiedInstructions.Add(new DataPatcherUnitTask
            {
                ...
                InstructionSet = new byte[]
                {
                    ...
                    0x83, 0x3C, 0xC5, 0x40, 0xC4, 0x16, 0x01,   // .text:005B8DD6                 cmp     ds:dword_116C440[eax*8], 1
                    ...
                    0xC7, 0x04, 0xC5, 0xE8, 0xD1, 0x16, 0x01,   // .text:005B8E09                 mov     ds:dword_116D1E8[eax*8], 1
                                                                // .text:005B8E14
                    ...
                    0xC7, 0x84, 0x81, 0x4C, 0xC4, 0x16, 0x01,   // .text:005B8F2F                 mov     ds:dword_116C44C[ecx+eax*4], 0
                    ...
                    0xC7, 0x84, 0x81, 0x44, 0x26, 0x20, 0x01,   // .text:005B8F51                 mov     ds:dword_1202644[ecx+eax*4], 0
