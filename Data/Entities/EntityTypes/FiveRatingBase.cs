...
namespace Data.Entities.EntityTypes
{
    public class FiveRatingBase : IFiveValue, IIdentity, IDataConnection
    {
        ...
        [Display(Name = "Name", Description = "Name of the item that has rating values.")]
        public string ResourceText { get; set; }

        [Display(Name = "⬛ ⬜ ⬜ ⬜ ⬜", Description = "Value used for the rating of 1 out of 5.")]
        public int Value01 { get; set; }
        [Display(Name = "⬛ ⬛ ⬜ ⬜ ⬜", Description = "Value used for the rating of 2 out of 5.")]
        public int Value02 { get; set; }
        [Display(Name = "⬛⬛⬛⬜⬜", Description = "Value used for the rating of 3 out of 5.")]
        public int Value03 { get; set; }
        [Display(Name = "⬛ ⬛ ⬛ ⬛ ⬜", Description = "Value used for the rating of 4 out of 5.")]
        public int Value04 { get; set; }
        [Display(Name = "⬛ ⬛ ⬛ ⬛ ⬛", Description = "Value used for the rating of 5 out of 5.")]
