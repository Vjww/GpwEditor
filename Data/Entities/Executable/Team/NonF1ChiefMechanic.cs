...
{
    public class NonF1ChiefMechanic : IIdentity, IDataConnection
    {
        private readonly Mapping.NonF1ChiefMechanic _valueMapping;
        ...
        public NonF1ChiefMechanic(Mapping.NonF1ChiefMechanic valueMapping, int id)
        {
            _valueMapping = valueMapping;

            Id = id;
            LocalResourceId = Mapping.NonF1ChiefMechanic.GetLocalResourceId(Id);
