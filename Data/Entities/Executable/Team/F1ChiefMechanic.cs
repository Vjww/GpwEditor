...
{
    public class F1ChiefMechanic : IIdentity, IDataConnection
    {
        private readonly Mapping.F1ChiefMechanic _valueMapping;
        ...
        public F1ChiefMechanic(Mapping.F1ChiefMechanic valueMapping, int id)
        {
            _valueMapping = valueMapping;

            Id = id;
            LocalResourceId = Mapping.F1ChiefMechanic.GetLocalResourceId(Id);
