...
{
    public class NonF1ChiefEngineer : IIdentity, IDataConnection
    {
        private readonly Mapping.NonF1ChiefEngineer _valueMapping;
        ...
        public NonF1ChiefEngineer(Mapping.NonF1ChiefEngineer valueMapping, int id)
        {
            _valueMapping = valueMapping;

            Id = id;
            LocalResourceId = Mapping.NonF1ChiefEngineer.GetLocalResourceId(Id);
