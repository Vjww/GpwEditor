...
{
    public class F1ChiefCommercial : IIdentity, IDataConnection
    {
        private readonly Mapping.F1ChiefCommercial _valueMapping;
        ...
        public F1ChiefCommercial(Mapping.F1ChiefCommercial valueMapping, int id)
        {
            _valueMapping = valueMapping;

            Id = id;
            LocalResourceId = Mapping.F1ChiefCommercial.GetLocalResourceId(Id);
