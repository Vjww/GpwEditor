...
{
    public class F1ChiefEngineer : IIdentity, IDataConnection
    {
        private readonly Mapping.F1ChiefEngineer _valueMapping;
        ...
        public F1ChiefEngineer(Mapping.F1ChiefEngineer valueMapping, int id)
        {
            _valueMapping = valueMapping;

            Id = id;
            LocalResourceId = Mapping.F1ChiefEngineer.GetLocalResourceId(Id);
