...
{
    public class GameExecutableValidator
    {
        ...
        public void Validate(string gameExecutablePath, string resolutionMessage)
        {
            var isValid = IsFileSupported(gameExecutablePath, out var validationMessage);
        ...
        private static bool IsFileSupported(string filePath, out string validationMessage)
        {
            ...
            if (isIdentified)
            {
                ...
                validationMessage = $"The selected game executable file has been identified as {isOfficialText} version {fileName} {version}.";
            ...
            if (fileLength == SupportedFileSize)
            {
                ...
                fileName = "gpw.exe";
                version = "v1.01b";
                validationMessage = $"The selected game executable file has been identified as a supported version of {fileName} {version}.";
                return true;
            }

            // Unidentified
            validationMessage = "The selected game executable file was unable to be identified as a valid game executable.";
            return false;
        }
