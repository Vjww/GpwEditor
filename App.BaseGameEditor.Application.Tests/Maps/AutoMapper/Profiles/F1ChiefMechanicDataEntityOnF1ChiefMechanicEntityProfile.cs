...
namespace App.BaseGameEditor.Application.Tests.Maps.AutoMapper.Profiles
{
    ...
    public class F1ChiefMechanicDataEntityOnF1ChiefMechanicEntityProfile
    {
        private readonly AutoMapperMapperService _mapperService;

        public F1ChiefMechanicDataEntityOnF1ChiefMechanicEntityProfile(ApplicationMapsFixture applicationMapsFixture)
        {
            _mapperService = applicationMapsFixture.GetService<AutoMapperMapperService>();
        }

        [Fact]
        public void F1ChiefMechanicDataEntityOnF1ChiefMechanicEntityProfile_WhenMappingFromPopulatedF1ChiefMechanicDataEntity_ExpectPopulatedF1ChiefMechanicEntity()
        {
            // Arrange
            var personDataEntityFactory = new IntegerIdentityFactory<F1ChiefMechanicDataEntity>(() => new F1ChiefMechanicDataEntity(new LanguageCatalogueValue()));
            var personEntityFactory = new IntegerIdentityFactory<F1ChiefMechanicEntity>(() => new F1ChiefMechanicEntity());
        ...
        [Fact]
        public void F1ChiefMechanicDataEntityOnF1ChiefMechanicEntityProfile_WhenMappingFromPopulatedF1ChiefMechanicEntity_ExpectPopulatedF1ChiefMechanicDataEntity()
        {
            // Arrange
            var personEntityFactory = new IntegerIdentityFactory<F1ChiefMechanicEntity>(() => new F1ChiefMechanicEntity());
            var personDataEntityFactory = new IntegerIdentityFactory<F1ChiefMechanicDataEntity>(() => new F1ChiefMechanicDataEntity(new LanguageCatalogueValue()));
