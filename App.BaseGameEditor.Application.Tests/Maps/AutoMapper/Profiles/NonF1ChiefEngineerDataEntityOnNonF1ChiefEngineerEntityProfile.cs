...
namespace App.BaseGameEditor.Application.Tests.Maps.AutoMapper.Profiles
{
    ...
    public class NonF1ChiefEngineerDataEntityOnNonF1ChiefEngineerEntityProfile
    {
        private readonly AutoMapperMapperService _mapperService;

        public NonF1ChiefEngineerDataEntityOnNonF1ChiefEngineerEntityProfile(ApplicationMapsFixture applicationMapsFixture)
        {
            _mapperService = applicationMapsFixture.GetService<AutoMapperMapperService>();
        }

        [Fact]
        public void NonF1ChiefEngineerDataEntityOnNonF1ChiefEngineerEntityProfile_WhenMappingFromPopulatedNonF1ChiefEngineerDataEntity_ExpectPopulatedNonF1ChiefEngineerEntity()
        {
            // Arrange
            var personDataEntityFactory = new IntegerIdentityFactory<NonF1ChiefEngineerDataEntity>(() => new NonF1ChiefEngineerDataEntity(new LanguageCatalogueValue()));
            var personEntityFactory = new IntegerIdentityFactory<NonF1ChiefEngineerEntity>(() => new NonF1ChiefEngineerEntity());
        ...
        [Fact]
        public void NonF1ChiefEngineerDataEntityOnNonF1ChiefEngineerEntityProfile_WhenMappingFromPopulatedNonF1ChiefEngineerEntity_ExpectPopulatedNonF1ChiefEngineerDataEntity()
        {
            // Arrange
            var personEntityFactory = new IntegerIdentityFactory<NonF1ChiefEngineerEntity>(() => new NonF1ChiefEngineerEntity());
            var personDataEntityFactory = new IntegerIdentityFactory<NonF1ChiefEngineerDataEntity>(() => new NonF1ChiefEngineerDataEntity(new LanguageCatalogueValue()));
