...
namespace App.BaseGameEditor.Application.Tests.Maps.AutoMapper.Profiles
{
    ...
    public class F1ChiefEngineerDataEntityOnF1ChiefEngineerEntityProfile
    {
        private readonly AutoMapperMapperService _mapperService;

        public F1ChiefEngineerDataEntityOnF1ChiefEngineerEntityProfile(ApplicationMapsFixture applicationMapsFixture)
        {
            _mapperService = applicationMapsFixture.GetService<AutoMapperMapperService>();
        }

        [Fact]
        public void F1ChiefEngineerDataEntityOnF1ChiefEngineerEntityProfile_WhenMappingFromPopulatedF1ChiefEngineerDataEntity_ExpectPopulatedF1ChiefEngineerEntity()
        {
            // Arrange
            var personDataEntityFactory = new IntegerIdentityFactory<F1ChiefEngineerDataEntity>(() => new F1ChiefEngineerDataEntity(new LanguageCatalogueValue()));
            var personEntityFactory = new IntegerIdentityFactory<F1ChiefEngineerEntity>(() => new F1ChiefEngineerEntity());
        ...
        [Fact]
        public void F1ChiefEngineerDataEntityOnF1ChiefEngineerEntityProfile_WhenMappingFromPopulatedF1ChiefEngineerEntity_ExpectPopulatedF1ChiefEngineerDataEntity()
        {
            // Arrange
            var personEntityFactory = new IntegerIdentityFactory<F1ChiefEngineerEntity>(() => new F1ChiefEngineerEntity());
            var personDataEntityFactory = new IntegerIdentityFactory<F1ChiefEngineerDataEntity>(() => new F1ChiefEngineerDataEntity(new LanguageCatalogueValue()));
