...
namespace App.BaseGameEditor.Application.Tests.Maps.AutoMapper.Profiles
{
    ...
    public class NonF1ChiefMechanicDataEntityOnNonF1ChiefMechanicEntityProfile
    {
        private readonly AutoMapperMapperService _mapperService;

        public NonF1ChiefMechanicDataEntityOnNonF1ChiefMechanicEntityProfile(ApplicationMapsFixture applicationMapsFixture)
        {
            _mapperService = applicationMapsFixture.GetService<AutoMapperMapperService>();
        }

        [Fact]
        public void NonF1ChiefMechanicDataEntityOnNonF1ChiefMechanicEntityProfile_WhenMappingFromPopulatedNonF1ChiefMechanicDataEntity_ExpectPopulatedNonF1ChiefMechanicEntity()
        {
            // Arrange
            var personDataEntityFactory = new IntegerIdentityFactory<NonF1ChiefMechanicDataEntity>(() => new NonF1ChiefMechanicDataEntity(new LanguageCatalogueValue()));
            var personEntityFactory = new IntegerIdentityFactory<NonF1ChiefMechanicEntity>(() => new NonF1ChiefMechanicEntity());
        ...
        [Fact]
        public void NonF1ChiefMechanicDataEntityOnNonF1ChiefMechanicEntityProfile_WhenMappingFromPopulatedNonF1ChiefMechanicEntity_ExpectPopulatedNonF1ChiefMechanicDataEntity()
        {
            // Arrange
            var personEntityFactory = new IntegerIdentityFactory<NonF1ChiefMechanicEntity>(() => new NonF1ChiefMechanicEntity());
            var personDataEntityFactory = new IntegerIdentityFactory<NonF1ChiefMechanicDataEntity>(() => new NonF1ChiefMechanicDataEntity(new LanguageCatalogueValue()));
